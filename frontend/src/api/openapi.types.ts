...
export interface paths {
  ...
  '/sheets/care-groups': {
    ...
    /** Get all care groups */
    get: operations['get_care_groups_sheets_care_groups_get']
    put?: never
    post?: never
    delete?: never
    options?: never
  ...
  '/sheets/new-follower': {
    ...
    put?: never
    /** post new follower */
    post: operations['post_new_follower_sheets_new_follower_post']
    delete?: never
    options?: never
    head?: never
    patch?: never
...
export interface components {
  schemas: {
    ...
    CareGroupsResponse: {
      /** Groups */
      groups: components['schemas']['CareGroup'][]
    }
...
export interface operations {
  ...
  get_care_groups_sheets_care_groups_get: {
    parameters: {
      query?: never
      header?: never
      path?: never
    ...
    responses: {
      ...
      200: {
        ...
        content: {
          'application/json': components['schemas']['CareGroupsResponse']
        }
      }
    }
  }
  post_new_follower_sheets_new_follower_post: {
    parameters: {
      query?: never
      header?: never
      path?: never
    ...
    requestBody: {
      content: {
        'application/json': components['schemas']['PostNewFollowerRequest']
      }
    }
    responses: {
      /** @description Successful Response */
